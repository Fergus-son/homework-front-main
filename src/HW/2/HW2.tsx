...
export const HW2 = () => {
  ...
  const filterUsers = (city: string) => {
    const filteredUsers = currentUsers.myFriends.filter(friend => { return friend.address.city === 'Los Angeles'})// 'НУЖНО ПРОФИЛЬТРОВАТЬ ДРУЗЕЙ. ОСТАВЛЯЕМ ТОЛЬКО ТЕХ, КОТОРЫЕ ЖИВУТ В ГОРОДЕ LOS ANGELES';
